                                            ...
                                            TextSelection.fromPosition(
                                                TextPosition(
                                                    offset: _controller.text
                                                        .toString()
                                                        .length));
                                        value = removeDollar(value.toString());
                                        if (value != '') {
              ...
              if (formKey.currentState!.validate()) {
                if (isSignatureDraw) {
                  ...
                  Map data = {
                    ...
                    'amount': totalamount,
                    'signatureUrl': await uint8ListTob64(),
                    // 'signatureUrl':
                  ...
                  callPaymentAPI(
                      totalamount,
                      widget.cardTokenResponse.data.cards.first.id,
                      widget.cardTokenResponse.data.cards.first.customer,
                      tip,
                      widget.referal,
                      widget.myurl,
                      widget.token);
                } else {
                  displaydialog(context, 'E-Sign', 'Please Sign before payment',
                      '', 'OK', 1);
                }
              }
            }),
